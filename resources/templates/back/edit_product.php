...
<div class="form-group">
      ...
      <textarea name="short_desc" id="" cols="10" rows="3" class="form-control"><?php echo $short_desc; ?></textarea>
    </div>
...
<aside id="admin_sidebar" class="col-md-4">
    ...
    <div class="form-group">
        ...
        <select name="product_category_id" id="" class="form-control">
            <option value="<?php echo $product_category_id; ?>"><?php echo show_category_title($product_category_id) ?></option>
            <?php get_categories_for_add_product() ?>
...
<!-- Product Tags -->
    ...
    <div class="form-group">
        ...
        <img src="../../resources/uploads/<?php echo $product_image; ?>" width="100" alt="">
